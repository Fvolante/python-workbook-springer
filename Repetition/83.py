...
generate_counter = 100
max_value = 0
old_value = 0
update = 0

while generate_counter > 0:
    
    # generate random number
    new_value = randint(1, 100)
   
    # check if new value is highest and print
    if new_value > max_value:
        max_value = new_value
        update += 1
        print(max_value, "<-- Il più alto!")
    else:
        print(new_value)
...
# print result
print("Il valore più alto è", max_value)
print("Il valore più alto è stato aggiornato", update, "volte")